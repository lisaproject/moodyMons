...
class WeeklyPerDiaryAdapter(val context: Context, var diaryPerDayList: ArrayList<Emotion>):
    BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val diaryView = inflater.inflate(R.layout.diary_item_view_weekly, parent, false)
